...
const DOCS = {
  ...
  config_fields: [
    ...
    { key: 'llm_proxy_auto_capture', desc: 'v1.23.0 代理响应后是否自动把整段对话入库（默认开）' },
  ...
  instance.addHook('preHandler', async (req, reply) => {
    ...
    instance.post('/api/config', strictRate, async (req, reply) => { reply.code(200);
      ...
      for (const k of ['qdrant_url', 'qdrant_collection', 'embedding_url', 'embedding_model', 'embedding_api_key', 'embedding_timeout_ms',
        ...
        // v1.23.0: LLM 代理旁路
        'llm_proxy_enabled', 'llm_proxy_url', 'llm_proxy_model', 'llm_proxy_api_key', 'llm_proxy_auto_capture', 'llm_proxy_capture_project', 'llm_proxy_user']) {
